...
public class ApplicationValue {
    ...
    public static final String WORD_PUNCUATION = "word_punct_pattern";
    public static final String BUNDLE_LOCATION = "by.epam.task02.infohandler.resourcebundle.Resources";
}
